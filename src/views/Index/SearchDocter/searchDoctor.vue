<template>
  <div class="searchDoctor">
    ...
    <div class="choose_expert">
      <img
        @click="choose"
        src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1594118184214&di=b09586981912c4a0a4255406619e626b&imgtype=0&src=http%3A%2F%2Fimg3.imgtn.bdimg.com%2Fit%2Fu%3D3837316838%2C3099869469%26fm%3D214%26gp%3D0.jpg"
      />
    </div>
    <!-- 预约服务 -->
    ...
    <div class="Appointment_booking_service docter">
      ...
      <div class="service_content pic">
        <div class="service_content_pic" v-for="(item,index) in docter" :key="index">
